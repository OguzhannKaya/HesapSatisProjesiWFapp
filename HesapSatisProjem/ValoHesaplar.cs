...
{
    public partial class ValoHesaplar : Form
    {
        public ValoHesaplar()
        {
            InitializeComponent();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("Select * from TblValoStok", baglanti);
            da.Fill(dt);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.Rows[e.RowIndex].Cells[5].Value.ToString() == "True")
            {
        ...
        {
            baglanti.Open();
            SqlCommand komut1 = new SqlCommand("insert into TblValoStok (HesapKullaniciAd,HesapSifre,HesapRank,Fiyat,HesapDurum) values (@p1,@p2,@p3,@p4,1)", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komut2 = new SqlCommand("Delete from TblValoStok where HesapId=@h1", baglanti);
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut3 = new SqlCommand("Update TblValoStok set HesapKullaniciAd=@p1,HesapSifre=@p2,HesapRank=@p3,Fiyat=@p4,HesapDurum=@p5 where HesapId=@p6",baglanti);
